...
namespace blt
{
	...
	::gpk::error_t								blockFileLoad						(::blt::TKeyValBlitterDB & jsonDB, uint32_t block);
	::gpk::error_t								blockFileName						(::gpk::array_pod<char_t> & filename, const ::gpk::view_const_string & dbName, const ::gpk::view_const_string & encryptionKey, const ::blt::DATABASE_HOST hostType, const uint32_t block);
	::gpk::error_t								tableFolderName						(::gpk::array_pod<char_t> & foldername, const ::gpk::view_const_string & dbName, const uint32_t block);
	::gpk::error_t								tableFileName						(::gpk::array_pod<char_t> & filename, const ::blt::DATABASE_HOST & hostType, const ::gpk::view_const_string & jsonDBKey);
